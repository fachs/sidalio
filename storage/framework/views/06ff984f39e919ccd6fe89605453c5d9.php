<?php $__env->startSection('title', 'Invoice2'); ?>
        ...
        <tbody>
            <tr>
                <td>
                    <table style="width: 100%;">
                        <tbody>
                            <tr>
                                <td><img src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt="logo">
                                    <address
            ...
            <tr>
                <td> <span style="display: flex; justify-content: end; gap: 15px;"><a
                            ...
                            href="<?php echo e(route('admin.invoice_2')); ?>" download="">Download<i class="icon-arrow-right"
...
<?php echo $__env->make('layouts.invoice.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/ecommerce/invoices/invoice_2.blade.php ENDPATH**/ ?>