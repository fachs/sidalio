                                    ...
                                    <tbody>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/product-categories/mouse.png')); ?>"
                                                            alt="mouse"></div>
                                                    <p>M185 Mouse</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/product-categories/headphone.png')); ?>"
                                                            alt="headphones"></div>
                                                    <p>Headphones</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/accessories/02.png')); ?>"
                                                            alt="green wireless mouse"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/accessories/01.png')); ?>"
                                                            alt="Grinder"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/shop-categories/phone.png')); ?>"
                                                            alt="i-phone"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/accessories/05.png')); ?>"
                                                            alt="wallet"></div>
                                                    <p>Wallet</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/shop-categories/watch.png')); ?>"
                                                            alt="watch"></div>
                                                    <p>Sport Watch</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/accessories/08.png')); ?>"
                                                            alt="projector"></div>
                                                    <p>Projector</p>
                                                </div>
                                            </td>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/reports/sales_return.blade.php ENDPATH**/ ?>