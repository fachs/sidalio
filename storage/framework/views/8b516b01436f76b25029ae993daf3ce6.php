                    ...
                    <div>
                        ...
                        <div class="login-main">
                            <form class="theme-form"  method="POST" action="<?php echo e(route('login')); ?>">
                             <?php echo csrf_field(); ?>
                                <h4>Masuk ke Akun</h4>
                                <p>Ketik username dan password untuk masuk</p>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <?php endif; ?>
                                    <div class="text-end">
                                        <button class="btn btn-primary btn-block w-100 mt-3 spinner-btn" type="submit">Masuk</button>
                                    </div>
                                </div>
                                </div>
                            </form>
...
<?php echo $__env->make('layouts.authentication.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>