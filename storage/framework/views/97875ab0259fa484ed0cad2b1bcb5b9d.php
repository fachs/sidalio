<?php $__env->startSection('title', 'Edit Penerimaan'); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit Penerimaan</h4>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 custom-input" id="penerimaanForm" action="<?php echo e(route('admin.penerimaan.update', $penerimaan->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-dalio\resources\views/admin/penerimaan/edit.blade.php ENDPATH**/ ?>