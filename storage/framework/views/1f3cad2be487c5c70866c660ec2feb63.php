...
<?php $__env->startSection('title', 'Detail Mutasi'); ?>
    ...
    <table style="width:1160px;margin:0 auto;">
        <tbody>
                    ...
                    <table style="width: 100%;">
                        <tbody>
                            <tr
                                ...
                                <td><img src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt="logo"></td>
                                <td>
                                    <ul
                                        ...
                                        <li> <svg class="stroke-icon"
                                                ...
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#call')); ?>"></use>
                                        ...
                                        <li
                                            ...
                                            <svg class="stroke-icon"
                                                ...
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#email-box')); ?>"></use>
                                            </svg><span
                                                style="color: #FFFFFF; font-weight: 500; font-size: 14px;">dinkes_kotsi@sanapati.net</span>
                                        </li>
                                        <li> <svg class="stroke-icon"
                                                style="height:16px; width: 16px; fill:#fff; margin-right: 10px; vertical-align:-2px;">
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#web')); ?>"></use>
                            ...
                            <tr style="display: flex; justify-content: space-between;">
                                <td> <span
                                        ...
                                        ke :</span><span
                                        style="font-size: 18px; display:block; font-weight: 600; color:rgba(0, 2, 72, 1); margin-bottom: 8px;"><?php echo e($mutasi->dbmb); ?></span><span
                            ...
                            <tr>
                                <td style="background: #F5F6F9;padding: 15px 25px;">
                                    <p
                                        ...
                                        Tanggal
                                        :</p><span style="font-size: 18px; font-weight: 600;"><?php echo e($mutasi->created_at); ?></span>
                                </td>
                                <td style="background: #F5F6F9;padding: 15px 25px;">
                                    <p
                                        style="font-size:16px; font-weight:500; color:#52526C; opacity:0.8; margin:0;line-height: 2;">
                                ...
                                <td style="background: #F5F6F9;padding: 15px 25px;">
                                    <p
                                        style="font-size:16px; font-weight:500; color:#52526C; opacity:0.8; margin:0;line-height: 2;">
                                        Total Nilai :</p><span style="font-size: 18px; font-weight: 600;"><?php echo e('Rp ' . number_format($mutasi->total_harga, 0, ',', '.')); ?></span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding: 16px; border-bottom: 1px solid rgba(82, 82, 108, 0.2);">
                                    <h4 style="font-weight:600; margin:4px 0px; font-size: 18px; color: #000248;"><?php echo e($obmhps->nama); ?></h4>
                                </td>
                                <td
                                    style="width: 12%; text-align: center;border-bottom: 1px solid rgba(82, 82, 108, 0.2);background: #F5F6F9;">
                                ...
                                <td
                                    ...
                                    <span style="color: #52526C;font-weight: 600;"><?php echo e($mutasi->jumlah); ?></span>
                                </td>
                                <td
                                    style="width: 12%; text-align: center; border-bottom: 1px solid rgba(82, 82, 108, 0.2);background: #F5F6F9;">
                                    <span style="color: #000248; font-weight: 600;opacity: 0.9;"><?php echo e('Rp ' . number_format($mutasi->total_harga, 0, ',', '.')); ?></span>
                                </td>
            ...
            <tr style="width: 100%; display: flex; justify-content: space-between; margin-top: 36px;">
                <td> <img src="<?php echo e(asset('assets/images/email-template/invoice-3/sign.png')); ?>" alt="sign"><span
...
<?php echo $__env->make('layouts.invoice.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-dalio\resources\views/admin/mutasi/detail.blade.php ENDPATH**/ ?>