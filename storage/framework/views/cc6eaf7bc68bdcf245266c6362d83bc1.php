...
<?php $__env->startSection('title', 'Tambah Stock Opname'); ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form class="row g-3 needs-validation" novalidate="">
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <label class="form-label" for="projectPriority">Sumber</label>
                                        <select class="form-select" id="projectPriority" required="">
                                            <option selected="">--Pilih--</option>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/dinas/dinas_so_tambah.blade.php ENDPATH**/ ?>