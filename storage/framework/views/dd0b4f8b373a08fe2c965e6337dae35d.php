                                    ...
                                    <div class="recent-table table-responsive custom-scrollbar">
                                        <table class="table" id="order-history-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1244</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1246</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1248</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1247</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1249</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1250</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1251</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1252</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1253</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1254</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1255</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1256</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1257</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1302</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1306</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1310</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1314</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1380</a></td>
                                                    <td>
                                                ...
                                                <tr class="inbox-data">
                                                    <td></td>
                                                    <td> <a href="<?php echo e(route('admin.order_details')); ?>">#1399</a></td>
                                                    <td>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/ecommerce/order/order_history.blade.php ENDPATH**/ ?>