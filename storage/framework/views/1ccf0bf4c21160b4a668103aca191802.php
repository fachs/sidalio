                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/1.png')); ?>"
                                                            alt="t-shirt"></div>
                                                    <p>Polo T-shirt</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/category/1.png')); ?>"
                                                            alt="shoes"></div>
                                                    <p>Shoes</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/category/2.png')); ?>"
                                                            alt="hand bags"></div>
                                                    <p>Handbags</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/category/3.png')); ?>"
                                                            alt="toys"></div>
                                                    <p>Toys</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/category/4.png')); ?>"
                                                            alt="slipper"></div>
                                                    <p>Slipper</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/shop-categories/camera.png')); ?>"
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/2.png')); ?>"
                                                            alt="t-shirt"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/product-categories/watch.png')); ?>"
                                                            alt="watch"></div>
                                                    <p>Watches</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/14.png')); ?>"
                                                            alt="t-shirt"></div>
                                                    <p>T-Shirts</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/shop-categories/mouse.png')); ?>"
                                                            alt="mouse"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/product-categories/dvd.png')); ?>"
                                                            alt="dvd"></div>
                                                    <p>DVD</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/product-categories/ipad.png')); ?>"
                                                            alt="slipper"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/accessories/07.png')); ?>"
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/email-template/3.png')); ?>"
                                                            alt="chair"></div>
                                                    <p>Accent Chair</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/12.png')); ?>"
                                                            alt="t-shirt"></div>
                                                    <p>T-Shirts</p>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/shop-categories/speaker.png')); ?>"
                                                            alt="speaker"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/product-categories/wireless-headphone.png')); ?>"
                                                            alt="ear buds"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/product-categories/phone.png')); ?>"
                                                            alt="phone"></div>
                                        ...
                                        <tr class="product-removes inbox-data">
                                            ...
                                            <td>
                                                <div class="product-names">
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/product/11.png')); ?>"
                                                            alt="t-shirt"></div>
                                                    <p>Solid T-shirt</p>
                                                </div>
                                            </td>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/ecommerce/category_page.blade.php ENDPATH**/ ?>