                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="light-product-box"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/dashboard-8/shop-categories/headphone.png')); ?>"
                                                            alt="headphone"></div>
                                                </td>
                                                <td>
                                                    <ul>
                                                        <li>
                                                            <h6> <a href="<?php echo e(route('admin.products_details')); ?>">Lightweight
                                                                    Headphones</a></h6>
                                                        </li>
                                                        <li>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>
                                                            <h6> <a href="<?php echo e(route('admin.products_details')); ?>">Smart
                                                                    Watch</a></h6>
                                                        </li>
                                                        <li>
                                                            <p>Fastrack</p><span
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>
                                                            <h6> <a href="<?php echo e(route('admin.products_details')); ?>">Leather
                                                                    Handbag</a></h6>
                                                        </li>
                                                        <li>
                                                            <p>Fendi</p><span
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        <li>
                                                            <h6> <a href="<?php echo e(route('admin.products_details')); ?>">Men's
                                                                    Shoes</a></h6>
                                                        </li>
                                                        <li>
                                                            <p>Sneaker</p><span
                        ...
                        <div class="card">
                            <div class="card-header card-no-border">
                                <div class="header-top summary-header">
                                    <h5>Summary</h5>
                                    <div class="card-header-right-icon"><a class="btn btn-primary" href="<?php echo e(route('admin.invoice_2')); ?>"
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/ecommerce/order/order_details.blade.php ENDPATH**/ ?>