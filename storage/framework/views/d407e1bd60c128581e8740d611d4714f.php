 <!-- latest jquery-->
    ...
    <script src="<?php echo e(asset('assets/js/script1.js')); ?>"></script><?php /**PATH C:\laragon\www\cuba-laravel\resources\views/layouts/comingsoon_layouts/scripts.blade.php ENDPATH**/ ?>