...
Route::group(['middleware' => ['auth'], 'as' => 'admin.', 'prefix' => 'admin'], function () {
    ...
    Route::resource('faskes', App\Http\Controllers\Admin\FaskesController::class);
    Route::resource('obmhp', App\Http\Controllers\Admin\ObmhpController::class);
    Route::resource('penerimaan', App\Http\Controllers\Admin\PenerimaanController::class);
     Route::resource('moned', App\Http\Controllers\Admin\MonedController::class);
     Route::resource('mutasi', App\Http\Controllers\Admin\MutasiController::class);
